 ...
 const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status >= 200 && response.status < 300) {
        ...
        window.location.href = '/productlist'; // Use window.location.href to navigate
      } else {
        ...
        <div className="mt-10">
          ...
          <div className="flex justify-center items-center gap-x-4">
            {productData.imageUrls.map((url, index) => (
              <div key={index} className="mb-2 flex flex-col justify-center items-center text-center">
                <img src={url} alt={`Current ${index + 1}`} className="w-32 h-32 object-cover rounded-md"/>
